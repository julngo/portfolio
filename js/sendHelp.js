...
var sendHelpPageHeader = '<div id="nav-bar"><ul><li><h1>Send Help</h1> </li><li><a><div onclick="fillSendHelpPageOne()">Home</div></a></li><li><a><div onclick="fillSendHelpPageTwo()">Pictures & Diagrams</div></a></li><li><a><div onclick="fillSendHelpPageThree()">Reflection</div></a></li></ul></div><div class="vl"></div><div class="sendHelp-content"></div>';
