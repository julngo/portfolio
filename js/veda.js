...
function fillHeaderVeda(){
    $('.navbar').html('<img id="headerPic" src="images/VedaAI_Logo.png"> <hr> <div class="items"><div onclick="fillVedaPageOne()"><p>Home</p></div><div onclick="fillVedaPageTwo()"><p>Research</p></div><div onclick="fillVedaPageThree()"><p>Concepting</p></div><div onclick="fillVedaPageFour()"><p>Prototypes</p></div></div>');
...
function fillVedaPageTwo(){
    removeVedaContent();
    $('.project-content').html(VedaPageTwo);
}

function fillVedaPageThree(){
    removeVedaContent();
    $('.project-content').html(VedaPageThree);
}

function fillVedaPageFour(){
    removeVedaContent();
    $('.project-content').html(VedaPageFour);
}
