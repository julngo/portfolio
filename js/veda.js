...
var pageHeader = '<div id="nav-bar"> <ul> <li><img style="float: left" id="headerPic" src="images/VedaAI_Logo.png"></li> <li onclick="fillPageOne()"><a><div>Home</div></a></li> <li onclick="fillPageTwo()"><a><div>Research</div></a></li> <li><a><div>App</div></a></li>  <li><a><div>Sketches</div></a></li> </ul> </div> <hr><div class="veda-content"></div>';
